...
func TestJSONShape(t *testing.T) {
	...
	s.SetStatsFunc(func() Stream { return Stream{Kbps: 8000, FPS: 59.9, EncodeMs: 4.2} })
	...
	if got.Version != "v1.2.3" || !got.Running || got.Encoder != "h264_nvenc" || got.ClientType != "classicEra" {
